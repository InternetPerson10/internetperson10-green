...
belt = {
    "mefeel": ["DOKO KARA KA"],
    "yamiwo": ["HARATTE YAMI WO HARATTE"],
    ...
    "bokura": ["WA BOKURA WA ANO KAKETA TSUKI NO", "BAKA NI NATTE CHUUUU WO MATTE", "WA INOCHI NI KIRAWARETEIRU"],
    "jibunwo": ["SEKAI SAE MO KAETE SHIMAE SOU NAAAAAA"],
    "amazing": ["JUST THE WAY YOU AAAAAARE"],
    "hey": ["KOUSHITE BOKU WA MATTEITA"],
    "sayang": ["NA SAAAAAYAAAAANG TALAGAAAAAAAAAAAAAAAAAAA"],
